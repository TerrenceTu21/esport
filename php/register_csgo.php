...
<head>
    ...
    <link rel="stylesheet" href="../css/registercsgo.css">
   


    <title >CSGO Registration</title>
...
<body>
            <div class="sign">
             <span class="fast-flicker">cs</span>go<span class="flicker"> regis</span>trat<span class="flicker">ion</span>
          </div>
        </form>
        </div>
        <?php 
        ...
        <form id="formcsgo" action="registration_result.php" method="post" style="text-align:center;">
        <input type="hidden" name="event_id" value="<?php echo $eventSelected; ?>">
            ...
            <tr>
              ...
              <tr>
                    ...
                    <td>
                    <input type="text"  name="phone" placeholder="012-1234567" value="<?php echo $_SESSION["phoneNo"]; ?>"maxlength="300" required/>
                    </td>
              </tr>
